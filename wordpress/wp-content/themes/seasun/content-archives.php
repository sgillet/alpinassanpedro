...
<?php if ( $seasun_options_db['seasun_display_meta_post_entry'] != 'Hide' ) { ?>
        <p class="post-meta">
...
<?php } ?>
        <div class="post-entry-content"><?php if ( $seasun_options_db['seasun_content_archives'] != 'Content' ) { ?><?php the_excerpt(); ?><?php } else { ?><?php global $more; $more = 0; ?><?php the_content(); ?><?php } ?></div>
<?php if ( $seasun_options_db['seasun_display_meta_post_entry'] != 'Hide' && has_category() ) { ?>
        <div class="post-info">
